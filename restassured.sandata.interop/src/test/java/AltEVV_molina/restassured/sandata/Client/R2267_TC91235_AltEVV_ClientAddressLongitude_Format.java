...
public class R2267_TC91235_AltEVV_ClientAddressLongitude_Format extends BaseTest{
	...
	{   
		...
		altEVVJsonObjectAddress.put("ClientAddressLongitude", "-181.99");
	...
	{   
		...
		JSONObject altEVVJsonObjectAddress = (JSONObject) altEVVJsonArrayAddress.get(0);
		altEVVJsonObjectAddress.put("ClientAddressLongitude", "-179");
	...
	{   
		...
		JSONObject altEVVJsonObjectAddress = (JSONObject) altEVVJsonArrayAddress.get(0);
		altEVVJsonObjectAddress.put("ClientAddressLongitude",CommonMethods.generateSpecialChar(10));

		JSONObject altEVVJsonObjectAddress_add = (JSONObject) altEVVJsonArrayAddress.get(1);
		altEVVJsonObjectAddress_add.put("ClientAddressLongitude",CommonMethods.generateSpecialChar(10));
