...
public class R2267_TC95238_AltEVV_Visit_ScheduleEndTime extends BaseTest{
	...
	public void R2267_TC95238_Visit_ScheduleEndTime_valid() throws FileNotFoundException, IOException, ParseException, SQLException{
		...
		jsonObjectVisit.put(globalVariables.ScheduleEndTimejson,CommonMethods.generatePastDate_YYYY_MM_dd()+ "T06:47:57Z");
	//	jsonObjectVisit.put(globalVariables.ScheduleStartTimejson,CommonMethods.generateTodayDate_YYYY_MM_dd()+ "T12:47:57Z");
