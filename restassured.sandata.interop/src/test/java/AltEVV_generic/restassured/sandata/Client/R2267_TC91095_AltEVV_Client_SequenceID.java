...
public class R2267_TC91095_AltEVV_Client_SequenceID extends BaseTest {
	...
	{   
		...
		CommonMethods.captureResponseAltEVV_400(j, CommonMethods.propertyfileReader(globalVariables.altevv_clients));
	...
	{   
		...
		JSONObject js = (JSONObject) j.get(0);
		js.put("SequenceID", CommonMethods.generateRandomNumberOfFixLength(50));
	...
	@Test 
	public void TC91095_Open_EVV_altEVV_Visit_changes_validate_sequenceID_invalid_format() throws IOException, ParseException, ConfigurationException
	{   
		// adding method name info via logger
		...
		//Validating the expected Result
		Assert.assertTrue(bodyAsString.contains("\"status\": \"FAILED\","));
		Assert.assertTrue(bodyAsString.contains( "The SequenceID value cannot be less than 0"));
