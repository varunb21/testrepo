...
public class R2267_TC91061_AltEVV_Latitude_Longitude_not_included extends BaseTest{
	...
	{   
		...
		js3.remove(globalVariables.ClientAddressLatitude);
		js3.remove(globalVariables.ClientAddressLongitude);
		...
		CommonMethods.verifyjsonassertFailcase(bodyAsString, "The ClientLongitude cannot be null");
