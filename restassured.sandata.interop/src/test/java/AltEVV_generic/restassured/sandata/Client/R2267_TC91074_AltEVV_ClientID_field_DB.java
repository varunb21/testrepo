...
public class R2267_TC91074_AltEVV_ClientID_field_DB extends BaseTest{
	...
	//Case-2 Testing with ClientID_String
	@Test 
	public void TC91074_AltEVV_ClientID_with_alphanumeric() throws IOException, ParseException, ConfigurationException, SQLException
	{   
		// adding method name info via logger
		logger = extent.startTest("TC91074_AltEVV_ClientID_with_String"); 
	...
	{   
		...
		CommonMethods.verifyjsonassertFailcase(bodyAsString, globalVariables.ClientIDNullError);
	}
