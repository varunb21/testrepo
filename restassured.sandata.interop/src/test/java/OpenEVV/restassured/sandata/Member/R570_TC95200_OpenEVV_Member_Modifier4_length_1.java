...
public class R570_TC95200_OpenEVV_Member_Modifier4_length_1 extends BaseTest {
	...
	@Test
	public void R570_TC95200_OpenEVV_Member_Modifier4_length_1_numeric() throws IOException, ParseException, SQLException
	{
		logger = extent.startTest("R570_TC95200_OpenEVV_Member_Modifier4_length_1_numeric"); 
		...
		jsonObjectProg.put("Modifier4", CommonMethods.generateRandomNumberOfFixLength(1));
	...
	@Test
	public void R570_TC95200_OpenEVV_Member_Modifier4_length_1_letter() throws IOException, ParseException, SQLException
	{
		...
		jsonObjectProg.put("Modifier4", CommonMethods.generateRandomStringOfFixLength(1));
		jsonObjectProg.put("PayerService", CommonMethods.generateRandomNumberOfFixLength(5));
