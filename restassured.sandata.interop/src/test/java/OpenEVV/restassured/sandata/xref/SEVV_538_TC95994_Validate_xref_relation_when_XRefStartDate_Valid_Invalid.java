...
public class SEVV_538_TC95994_Validate_xref_relation_when_XRefStartDate_Valid_Invalid extends BaseTest{
	...
	//To validate the invalid Xref end date with invalid date (2018-07-23)
			@Test 
			public void TC95994_Validate_xref_relation_when_XRefStartDate_Invalid_2018_07_23() throws IOException, ParseException, ConfigurationException
			{
			...
			@Test 
			public void TC95994_Validate_xref_relation_when_XRefStartDate_Invalid_case2() throws IOException, ParseException, ConfigurationException
			{
			...
			//To validate the invalid Xref end date with invalid format "07-23-2018" 
			@Test 
			public void TC95994_Validate_xref_relation_when_XRefStartDate_Invalid_format_case3() throws IOException, ParseException, ConfigurationException
			{
				logger = extent.startTest("TC95997_Validate_xref_relation_when_XRefStartDate_Invalid_format_07-23-2018");  // adding method name info via logger
			...
			public void TC95994_Validate_xref_relation_when_XRefStartDate_valid_in_inbox_and_stx_DB() throws IOException, ParseException, ConfigurationException, java.text.ParseException, SQLException
			{
