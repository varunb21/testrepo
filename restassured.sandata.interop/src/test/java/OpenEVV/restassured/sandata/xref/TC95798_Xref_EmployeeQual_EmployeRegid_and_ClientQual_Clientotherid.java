...
public class TC95798_Xref_EmployeeQual_EmployeRegid_and_ClientQual_Clientotherid extends BaseTest
{
	...
	@Test(priority=0)
	public void TC95798_Xref_EmployeeQual_EmployeRegid_and_ClientQual_Clientotherid_valid() throws IOException, ParseException, ConfigurationException, SQLException, java.text.ParseException
	{
		...
		Assert.assertEquals(DataBaseVerifier_Client.workerIdQualifier_inboxXref,"STX_ID" );
		Assert.assertEquals(DataBaseVerifier_Client.clientIdQualifier_inboxXref,"CLIENT_ID_CUSTOM2" );
