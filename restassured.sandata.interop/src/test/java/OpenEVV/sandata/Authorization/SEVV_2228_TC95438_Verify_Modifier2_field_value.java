...
public class SEVV_2228_TC95438_Verify_Modifier2_field_value extends BaseTest{
	...
	@Test
	public void TC95438_Verify_Modifier2_field_value_invalid() throws IOException, ParseException, ConfigurationException, SQLException, Exception
	{
	...
	@Test
	public void TC95438_Verify_Modifier2_field_value_invalid_morethan_allowed_length() throws IOException, ParseException, ConfigurationException, SQLException, Exception
	{
		...
		String bodyAsString = CommonMethods.captureResponsePostAuthrization(jsonArray, CommonMethods.propertyfileReader("molina_auth"));
		CommonMethods.verifyjsonassertFailcase(bodyAsString, globalVariables.Modifier2FormatError);
		CommonMethods.verifyjsonassertFailcase(bodyAsString, globalVariables.Modifier2FormatvalueError);
		

}
	@Test
	public void TC95438_Verify_Modifier2_field_value_valid() throws IOException, ParseException, ConfigurationException, SQLException, Exception
	{
	...
	@Test
	public void TC95438_Verify_Modifier2_field_value_valid_null() throws IOException, ParseException, ConfigurationException, SQLException, Exception
	{
