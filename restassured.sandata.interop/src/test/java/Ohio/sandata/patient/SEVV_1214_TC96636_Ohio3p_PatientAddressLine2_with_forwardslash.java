 ...
 *
 */
public class SEVV_1214_TC96636_Ohio3p_PatientAddressLine2_with_forwardslash extends BaseTest {
	
	@Test
	public void TC96636_Ohio3p_PatientAddressLine2field_with_forwardslash() throws IOException, ParseException, ConfigurationException, SQLException, Exception
	{
		logger = extent.startTest("TC96635_Ohio3p_PatientAddressLine2field_with_forwardslash"); 
		...
		jsonObjectAdd.put("PatientAddressLine2", CommonMethods.generateRandomStringOfFixLength(2) +"/" +CommonMethods.generateRandomStringOfFixLength(1) + CommonMethods.generateRandomStringOfFixLength(4));
