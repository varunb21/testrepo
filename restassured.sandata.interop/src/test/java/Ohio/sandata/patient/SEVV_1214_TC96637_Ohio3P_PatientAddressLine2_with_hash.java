 ...
 *
 */
public class SEVV_1214_TC96637_Ohio3P_PatientAddressLine2_with_hash extends BaseTest {

	
	@Test
	public void TC96637_Ohio3P_PatientAddressLine2_with_hash() throws IOException, ParseException, ConfigurationException, SQLException, Exception
	{
		logger = extent.startTest("TC96637_Ohio3P_PatientAddressLine2_with_hash"); 
		...
		jsonObjectAdd.put("PatientAddressLine2", CommonMethods.generateRandomStringOfFixLength(2) +"#" +CommonMethods.generateRandomStringOfFixLength(1) + CommonMethods.generateRandomStringOfFixLength(3));
